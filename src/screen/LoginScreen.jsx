...
import { handleSendEmail } from '../utils/auth/email';
...
const LoginScreen = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      if (!isEmailVerified) {
        ...
        Alert.alert("Veuillez vérifier votre adresse e-mail pour vous connecter.");
        return;
      }
  ...
  const handleResendVerificationEmail = async () => {
    ...
    if (emailSent) {
      ...
      Alert.alert("Une erreur s'est produite lors de l'envoi de l'e-mail de vérification.");
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      {!emailVerified && (
        <TouchableOpacity style={styles.button} onPress={handleResendVerificationEmail}>
