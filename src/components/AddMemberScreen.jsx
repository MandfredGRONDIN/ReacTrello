...
import { getUserByEmail } from '../utils/user/read'
import { addMemberToProject } from '../utils/user/update'
import { getMembersByProjectId } from '../utils/user/read'
import { removeMemberFromProject } from '../utils/user/delete'
...
const AddMemberScreen = () => {
    ...
    const fetchMembers = async () => {
        try {
            ...
            setLoading(false)
            Alert.alert('Erreur', 'Échec de la récupération des membres.')
        }
    }
